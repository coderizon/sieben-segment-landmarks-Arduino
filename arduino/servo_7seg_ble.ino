 ...
 * Protokoll: Nordic UART Service (kompatibel mit gängigen BLE-Serial-Apps)
 *
 * Erwartet einzelne Zeichen '0'–'9' (oder 'x' zum Abschalten) über BLE.
 */
#if 0
...
// Konstanten für die Servo-Positionen
...
void setup() {
  ...
  Serial.println("BLE bereit. Verbinde dich und sende eine Zahl (0-9) oder 'x'.");
}
